  ...
  return (
    <div
      className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 
                       z-30 max-w-2/3  mx-4 max-h-[85vh] bg-white dark:bg-stone-800 
    ...
    >
      <div className="relative w-full h-full flex flex-col">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-stone-900 dark:text-white leading-tight">{stationName}</h2>

          <button
            onClick={onClose}
            className="p-2 rounded-lg text-stone-500 hover:text-stone-700 
        ...
        <div className="flex gap-3 mb-6">
          ...
          >
            ...
            <span>{isStarred ? t("bookmarked") : t("bookmark")}</span>
          </button>
        </div>
