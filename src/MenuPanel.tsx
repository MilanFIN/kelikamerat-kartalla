  ...
  return (
    <div
      ...
      className={`absolute bg-white dark:bg-stone-800 shadow-2xl z-30 
                       ...
                       ${isPortrait ? "top-20 left-0 w-full min-h-64 border-b" : "top-0 left-20 h-full w-80"}`}
    >
      <div className="p-6 border-b border-stone-200 dark:border-stone-700">
        <h2 className="text-2xl font-bold text-stone-900 dark:text-white">Menu</h2>
      </div>
      ...
      <div className="p-6">
        ...
        <ul className="space-y-2">
          {stations.length > 0 ? (
            ...
            <li className="text-stone-500 dark:text-stone-400 text-center py-8 italic">No bookmarked stations yet</li>
          )}
        </ul>
      </div>
    </div>
